...
//     use rstest::rstest;
//
//     async fn make_event_store_with_one_event() -> InMemoryEventStore<TimeEntryEvent> {
//         let (tx, _) = broadcast::channel(16);
//         let store = InMemoryEventStore::<TimeEntryEvent>::new_with_sender(tx);
...
//
//     fn make_projector(
//         store: InMemoryProjectionStore<ListTimeEntriesState>,
//         event_store: InMemoryEventStore<TimeEntryEvent>,
//     ) -> (
...
//         let event_store = InMemoryEventStore::<TimeEntryEvent>::new_with_sender(
//             tx.clone(),
//         );
